...
import { Platform, Linking, TextStyle } from 'react-native'
import {Text as NativeText, P as dripsyP, H1 as H1dripsy } from 'dripsy'
import { styled, StyledProps } from 'nativewind'
// import { TextLink as SolitoTextLink } from 'solito/link'

export const Text = styled(NativeText)
export const P = styled(dripsyP)
export const H1 = styled(H1dripsy)
// import { ComponentProps, forwardRef } from 'react'
